...
public class LoginFrm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().trim().length()==0 || jPasswordField1.getText().trim().length()==0){
           JOptionPane.showMessageDialog(this, "Vui lòng điền đầy đủ tên tài khoản và mật khẩu !");
           return;
        }
        ...
        if (ud.checkLogin(user)) {
            if (user.getRole().equalsIgnoreCase("reception")) {
                (new ReceptionistHomeFrm(user)).setVisible(true);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Bạn không phải lễ tân !");
                this.dispose();
            }
        } else {
